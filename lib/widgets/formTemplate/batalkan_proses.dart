              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 12,),
                    Text("Yakin ingin membatalkan proses?",
                    ...
                    SizedBox(height: 12,),
                    Text("Semua proses yang sudah Anda lakukan tidak akan tersimpan.",
                      maxLines: 5,
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
                    ...
                    SizedBox(
                      height: 53,
                      child: CustomButton(
                        label: Text("Nggak Deh, Mau Lanjut",
                          style: GoogleFonts.poppins(
                            color: Colors.white,
